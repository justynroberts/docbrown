...
documentation:
  ...
  generated_by: ""   # optional: custom attribution text
...
Change the "Generated by" text in documentation footers:

```yaml
# .docbrown.yaml
documentation:
  generated_by: "My Company Documentation System"
```

Or remove attribution entirely:
